...
| BLACKHOLE_PROCESS_CHUNK_SIZE | -                                                                                                                                                                                                                                                            | 10                             |
| BLACKHOLE_SYNC_SCHEDULE      | CRON-like schedule string that configures when sync and download tasks will be runned. Based on [node-schedule syntax](https://github.com/node-schedule/node-schedule?tab=readme-ov-file#cron-style-scheduling). Default schedule run tasks every 15 minutes | */15 * * * *                   |
